...
Some small but useful macros are \verb+\LuaTeX+ and
\verb+\LuaLaTeX+ that produce \LaTeX\ and \LuaLaTeX .
...
\subsection{\file{.lua} module template\label{sub:luatemplate}}
